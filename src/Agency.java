...
public class Agency {
	...
	public void agencyStart(int minutes) {
		...
		int thetimeore, thetimeminute;
		thetimeore = (int) waitingTimeSum / clientsHistory.size()/60;
		thetimeminute= (int) waitingTimeSum / clientsHistory.size()-thetimeore*60;
		//System.out.println("Timpul mediu de stat in coada este : " + (double) waitingTimeSum / clientsHistory.size());
		System.out.println("Timpul mediu de stat in coada este : " + thetimeore+ "ore si " +thetimeminute+ "minute");
		
		thetimeore = (int) totalTime / clientsHistory.size()/60;
		thetimeminute= (int) totalTime / clientsHistory.size()-thetimeore*60;
		//System.out.println("Timpul petrecut de clientii in institutie este : " + (double) totalTime / clientsHistory.size());
		System.out.println("Timpul petrecut de clientii in institutie este : " + thetimeore+ "ore si " +thetimeminute+ "minute");
		System.out.println("Coada a avut lungimea maxima de " + maxNumberOfClientsInQueue+ " clienti");
